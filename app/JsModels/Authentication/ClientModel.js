class ClientModel {
    ...
    setClientRoleName($clientRoleName) {
        this.clientRoleName = $clientRoleName;
    }

    getClientRoleMachineName() {
        return this.clientRoleMachineName;
    }

    setClientRoleMachineName($clientRoleMachineName) {
    ...
    getClientLastConnectionDate() {
        return this.clientLastConnectionDate;
    }

    setClientLastConnectionDate($clientLastConnectionDate) {
    ...
    getAuthentication_terminal_url() {
        return this.authentication_terminal_url;
    }

    setAuthentication_terminal_url($authentication_terminal_url) {
